...
import nways.towtruck.provider.crud.RegisterActivity;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String finalResult ;
    String HttpURL = "http://172.20.10.3/towtruckbackend/ProviderLogin.php";
        ...
        class UserLoginClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                if(httpResponseMsg.equalsIgnoreCase("Data Matched")){
                    ...
                    Intent intent = new Intent(LoginActivity.this, ProviderScreen.class);
                    intent.putExtra(UserEmail, email);
                    startActivity(intent);
                }
                else Toast.makeText(LoginActivity.this, httpResponseMsg, Toast.LENGTH_LONG).show();
            }
