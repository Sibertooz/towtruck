...
public class ProviderScreenMain extends AppCompatActivity implements View.OnClickListener, LocationListener, GoogleMap.OnMarkerClickListener {
    Switch btnSwitch;
    ...
    String nameUser, emailUser, myEmail;
    double latUser, lngUser;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_provider_screen_main);
        ...
        latUser = getIntent().getDoubleExtra("latUser", 0);
        lngUser = getIntent().getDoubleExtra("lngUser", 0);
    ...
    private void showMyLocation() {
        ...
        if (myLocation != null) {
            ...
            userOption.title(nameUser).position(new LatLng(latUser, lngUser))
                    .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE))
                    .anchor(0.5f, 0.5f);
            Marker userMarker = myMap.addMarker(userOption);
            userMarker.showInfoWindow();
            userMarker.setTag("userTag");
    ...
    public boolean onMarkerClick(Marker marker) {
        if (marker.getTag().toString().equals("myTag")) return true;
            ...
            startActivity(new Intent(ProviderScreenMain.this, ProviderChat.class)
                    .putExtra("from_email", emailUser).putExtra("to_email", myEmail));
        }
        return false;
    }
    ...
    public void onClick(View v){
        ...
        switch(v.getId()) {
            ...
            case R.id.btnInfo:
                ...
                intent.putExtra(finalEmail, myEmail);
