...
public class UserRegister extends AppCompatActivity implements View.OnClickListener{
    ...
    String HttpURL = "http://172.20.10.3/towtruckbackend/UserRegistration.php";
    ...
    public void ProviderRegistration(final String name, final String phone, final String email,
        ...
        class ProviderRegistrationClass extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                progressDialog = ProgressDialog.show(UserRegister.this,"Loading Data",
                        null,true,true);
            }
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                Toast.makeText(UserRegister.this, httpResponseMsg, Toast.LENGTH_LONG).show();
